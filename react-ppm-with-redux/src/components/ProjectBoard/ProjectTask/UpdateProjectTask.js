...
class UpdateProjectTask extends Component {
    ...
    componentDidMount() {
        this.props.onGetProjectTask(this.state.projectIdentifier, this.state.pt_id);
...
const mapStateToProps = state => ({
    ...
    project_task: state.brReducer.projectTask
...
const mapDispatchToProps = dispatch => {
    return {
        onGetProjectTask: (pId, ptId) => dispatch(actions.getProjectTask(pId, ptId))
